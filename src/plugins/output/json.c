...
static entity_t g_entities[255] = {
    ...
    "\\u0019", "\\u001a", "\\u001b", "\\u001c", "\\u001d", // 20-29
    "\\u001e", "\\u001f", NULL,      NULL,      "\\\"",
    NULL,      NULL,      NULL,      NULL,      NULL, // 30-39
    ...
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 100-109
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 110-119
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      "\\u007f", NULL,      NULL, // 120-129
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 130-139
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 140-149
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 150-159
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 160-169
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 170-179
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 180-189
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 190-199
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 200-209
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 210-219
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 220-229
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 230-239
    NULL,      NULL,      NULL,      NULL,      NULL,
    NULL,      NULL,      NULL,      NULL,      NULL, // 240-249
    NULL,      NULL,      NULL,      NULL,      NULL, // 250-254
};

// ------------------------------------------------------------------------- //

static char *escape_json(const struct format *format, const char *str)
{
                      ...
                      const char *value)
{
    ...
    case OUTPUT_TYPE_ATTRIBUTE:
        ...
        putchar('\n');
        if (key && value) {
            printf(INDENT(indent, "\"%s\": \"%s\""), escaped_key,
                   escaped_value);
        } else if (key) {
            printf(INDENT(indent, "\"%s\""), escaped_key);
        } else if (value) {
